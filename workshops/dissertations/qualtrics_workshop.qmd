...
If you'd like the complete version, see the [Solutions version of this same workshop tutorial](qualtrics_workshop_sol.qmd) which includes all code for exercises along with extra tips and explanations.
