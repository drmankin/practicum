...
::: {.callout-note title="Exercise" appearance="minimal"}
Follow along with the instructions below to create your own beautiful table.
:::
...
For the first bit - well, this is well beyond anything we've covered so far, including a good bit of base R and some jiggery-pokery to get only *N* and *SD* to be italicised. (Sorry.) The steps are annotated below, which together produce a vector of column names to pass to `kbl()`.
