...
Once we have these lovely summary tables, it would be great to include them in a report or paper, but they definitely some formatting first. There are a couple options for this, one using the familiar {papaja} package, and the other with the new {kableExtra} package.
