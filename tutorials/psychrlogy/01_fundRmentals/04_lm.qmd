...
If you encounter this issue, you may need to [inspect and clean your dataset](..\02_essentials\06_filter.qmd) before you proceed with analysis!
:::
...
2.  The [**body text**](04_lm.qmd#headings-and-text), which contains regular (i.e. non-code) text
...
In the Posit Cloud project workspace for this tutorial, there is a `teaching.csv` object. Look back on [Tutorial 02](03_datasets.qmd) for more detail about how to read in datasets.
...
-   They can be automatically converted into a [table of contents](04_lm.qmd#table-of-contents)
...
::: callout-tip
This section will make extensive use of `$` subsetting, which was covered in [Tutorial 02](03_datasets.qmd), and `[]` subsetting, which was covered in [Tutorial 01](01_02_intro.qmd).
:::
