...
We already saw how to convert strings to sentence case in the example above. However, all we've *actually* done is replaced the first letter of the string with the capitalised versio of the same letter. If you happen to want to do this with base R regex instead, here's an option:
