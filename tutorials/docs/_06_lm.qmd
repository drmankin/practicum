...
::: callout-tip
This section will make extensive use of `$` subsetting, which was covered in [Tutorial 03](03_datasets.qmd), and `[]` subsetting, which was covered in [Tutorial 01](01_intro.qmd).
:::
...
::: {.callout-note collapse="true" title="Solution"}
**CHALLENGE**: Finally, add a note along with the table explaining what the symbols could be presented next to the p-value and what they mean. 
