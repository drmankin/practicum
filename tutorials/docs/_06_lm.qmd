...
Fit a single-predictor linear model, with ??? as the outcome and ??? as the predictor. Obtain model parameters and fit statistics for this model.

::: {.callout-note collapse="true" title="Solution"}
```{r}
## Use syn_data instead?
```
...
Fit a three-predictor linear model and obtain model parameters, fit statistics, and standardised *b*s.
...
Conduct assumptions checks for the final model, including diagnostic plots and sensitivity tests.
