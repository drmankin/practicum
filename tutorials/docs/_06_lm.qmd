...
syn_inter_lm <- lm(scsq_imagery ~ syn_graph_col*syn_seq_space, data = syn_data)
...
::: {.callout-note appearance="minimal" title="Exercise"}
We have done quite a lot and your Quarto document may be a bit messy. Go through your document and make it look... nicer - add comments to the code ..... <!-- EXPAND HERE -->
Finally, render your linear model report to a Word document.
