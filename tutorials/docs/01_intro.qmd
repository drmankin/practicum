...
# Names too many words (not concise)
...
Compare these results to above. The results in `monday_quiz_t_test` - now, the "Monday" object contains the results for the Tuesday data.
