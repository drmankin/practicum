...
chi_tea |> 
  ...
  scale_fill_discrete(name = "Believed Position",
                      labels = c("Left", "Right"),
                      type = c("#36024d", "darkcyan")) + # AnD colours, heck yeah!!
  theme_bw()
```
