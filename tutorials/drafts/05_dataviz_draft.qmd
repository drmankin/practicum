...
Alternatively, read in a dataset of your choice.
...
If you're really keen on data visualation with {ggplot2}, check out Tidy Tuesdays. Each week, there's a new dataset released, and people build and share beautiful visualisations, along with the code and frequently their process!

:::

### Layers

Plots in {ggplot2} are built in layers. Each layer is a function that is added to the plot, building it up piece by piece. 
